...
ALLOWED_HOSTS = [
    "saas-foundations-production-d46d.up.railway.app",  # https://saas.prod.railway.app
]
if DEBUG:
...
# source for python manager.py collectstatic
STATICFILES_DIRS = [STATICFILES_BASE_DIR]

# OUTPUT for python manager.py collectstatic
